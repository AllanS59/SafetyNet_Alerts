...
public interface SpecificQueriesService {
	...
	/**
	 * get needed information of people covered by a specific firestation, with
	 * count of adults and children
	 * 
	 * @param station number of the firestation requested
	 * @return PersonsByFirestationNbAdultsDTO DTO object containing several
	 *         information
	 */
	 ...
	 * 
	 * @param station number of the firestation requested
	 * @return PersonsPhonesByFirestationDTO DTO object containing several
	 *         information
	 */
	public String[] getPhonesByFirestation(int station);

	/**
	 * get list of persons from a specific address and precise the corresponding
	 * firestation
	 * 
	 * @param station number of the firestation requested
	 * @return PersonsFirestationByAddressDTO DTO object containing several
	 *         information
	 */
	 ...
	 * 
	 * @param station number of the firestation requested
	 * @return AddressesPersonsByFirestationDTO DTO object containing several
	 *         information
	 */
	 ...
	 * @return PersonNameAddressAgeMailMedicalsDTO DTO object containing several
	 *         information
	 */
